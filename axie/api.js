export async function getAxieDetails(id) {
...
export async function getAxiesByAddress(address, offset, parts="null", cls="", purenesses="") {
...
export async function getProfileByEthAddress(address) {
